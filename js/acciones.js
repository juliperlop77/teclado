//JavaScript
// Todo lo que se ponga después de ésta línea de código se va a ejecutar después de que esté listo el documento.	
$(document).ready(function(e){	
	 $('#principal').height($('#page').height());
	document.addEventListener("deviceready",function(){
// Todo lo que se ponga después de ésta línea de código se va a ejecutar después de que esté listo el dispositivo esté listo.
